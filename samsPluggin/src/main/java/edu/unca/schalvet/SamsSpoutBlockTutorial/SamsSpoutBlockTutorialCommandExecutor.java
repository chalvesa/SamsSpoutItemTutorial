 ...
 */
public class SamsSpoutBlockTutorialCommandExecutor implements CommandExecutor {
	 ...
	 * from
	 */
	public SamsSpoutBlockTutorialCommandExecutor(SamsSpoutBlockTutorial plugin) {
		this.plugin = plugin;
	}
	...
	public boolean onCommand(CommandSender sender, Command command,
		...
		if (!(sender instanceof Player)) {
			...
			testBlock = new DiceBlock(plugin);
			Player player = (Player) sender;
